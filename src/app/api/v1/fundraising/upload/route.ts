...
// Use Node runtime so we can safely access server env vars and the service role client.
export const runtime = 'nodejs';

export async function POST(req: NextRequest) {
  try {
    console.log('=== FUNDRAISING UPLOAD START ===');
    ...
    const filePath = `fundraising/${fileName}`;
    ...
    console.log('=== FUNDRAISING UPLOAD END ===');
